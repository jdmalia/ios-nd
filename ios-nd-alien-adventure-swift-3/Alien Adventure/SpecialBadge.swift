...
class SpecialBadge: Badge {
    ...
    override init(requestType: UDRequestType) {
        ...
        let specialBadgeTexture = SKTexture(imageNamed: "BadgeTeal")
        self.texture = specialBadgeTexture
        
        let animationType : BadgeAnimation = BadgeAnimation( rawValue: Int(arc4random_uniform(3)) )!
