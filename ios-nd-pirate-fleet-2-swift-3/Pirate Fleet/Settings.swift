...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! It's coming for you.."
        static let ComputerHitMonster = "The computer has hit a sea monster! Bad news for it."
